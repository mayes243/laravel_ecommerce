                ...
                <div class="forms">
                    ...
                    <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                        ...
                        <div class="form-body" style="background:linear-gradient(rgba(0,0,100,0.2),rgba(0,0,90,0.11)); color:purple; font-family:'',cursive;">
                            ...
                            <form method="post" action="{{route('updateorder',$e->id)}}">
                                {{csrf_field()}}
                                <div class="form-group">
                                <label for="exampleInputEmail1">Total Order:</label>

                                <input type="text" class="form-control" placeholder="Enter total order" name="torder" value="{{$e->order_total}}">
                                </div>
                                <div class="form-group">
                                <label for="exampleInputEmail1">Order Status:</label>

                                <input type="text" class="form-control" placeholder="Enter order status" name="ostatus" value="{{$e->order_status}}">
                                </div>
