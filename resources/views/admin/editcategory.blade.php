                ...
                <div class="forms">
                    ...
                    <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                        ...
                        <div class="form-body" style="background:linear-gradient(rgba(0,0,100,0.2),rgba(0,0,10,0.02)); color:purple; font-family:'',cursive;">
                            ...
                            <form method="post" action="{{route('updatecat',$edit->id)}}">
                                {{csrf_field()}}
                                <div class="form-group">
                                <label for="exampleInputEmail1">Category Name:</label>
                                 <input type="text" class="form-control" placeholder="Enter Manufacture Name" name="categoryname" value="{{$edit->category_name}}">
                                </div>

                                <div class="form-group">
                                <label for="exampleInputEmail1">Category Description:</label>
                                <input type="text" class="form-control" placeholder="Enter Your Manufacture Description" name="categorydesc" value="{{$edit->category_description}}">
                                </div>
                                <div class="form-group">
                                <label for="exampleInputEmail1">Publication Status:</label>
                                <input type="hidden" name="modifiedby" value="{{Auth::user()->username}}">
